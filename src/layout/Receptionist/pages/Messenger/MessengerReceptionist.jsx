...
import CreateAppointmentModal from "@/layout/Admin/components/Modal/CreateAppointmentModal"
...
const MessengerReceptionist = () => {
    ...
    const { mutate: getConversationFromSearch } = useGetConversationFromSearch()
                ...
                {conversationLoading || conversationSidebarLoading ? (
                    ...
                    <>
                        ...
                        {sidebarVisible && (
                            ...
                            >
                                <div className="flex items-center justify-start gap-2 bg-primary-tw text-white p-4 text-center text-lg font-semibold h-16">
                        ...
                        <Layout className="flex flex-col h-full">
                            <div className="bg-white border-b border-gray-300 flex items-center justify-between h-16 px-4 ">
                                ...
                                {conversationSelected ? (
                                    <div className="flex flex-wrap justify-between items-center w-full">
                                        ...
                                        <button className="bg-primary-tw text-white px-3 rounded-md text-center py-2" onClick={() => setShowCreateAppointmentModal(true)}>
                                            Tạo lịch hẹn
                                        </button>
                                    </div>
                                ) : (
