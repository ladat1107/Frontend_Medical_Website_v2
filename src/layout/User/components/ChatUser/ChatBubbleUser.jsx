...
import { Drawer, Input, Button, Avatar, Form } from "antd";
    ...
    <div className="chat-bubble-container">
      ...
      <Drawer
        ...
        title={<div className="chat-title">
          ...
          <div className="title" >Hỗ trợ trực tuyến <DropdownSelectMessage /></div>
      ...
      >
        ...
        <Form form={form} onFinish={sendMessage} className="chat-input-container">
